const SocialIcons = ({ darkMode, type }) => {
  const isFooter = type === "footer";
  const iconWrapperClasses = isFooter
    ? "flex items-start"
    : "flex dark:hover:bg-neutral-600 hover:bg-neutral-200 duration-200 h-[45px] w-[45px] cursor-pointer items-center justify-center rounded-[8px] border-2 border-neutral-200 bg-neutral-100 outline-none focus:ring-2 focus:ring-blue-700 dark:border-neutral-700 dark:bg-neutral-900";

  return (
    <aside className="mt-6 flex">
      <ul className="flex list-none gap-2">
        <li className={iconWrapperClasses}>
          <a href="">
            <svg
